      ...
      <div className="relative flex min-h-[50rem] md:min-h-screen w-full items-center justify-center bg-black overflow-hidden px-4 py-16">
        ...
        <div className="relative z-20 text-center">
          ...
          <div className="flex justify-center gap-4 mt-6 text-2xl">
            <a
              href="https://github.com/Rahulguguloth"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/g_rahul18/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/in/guguloth-rahul-97095435a"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://leetcode.com/GugulothRahul/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://codeforces.com/profile/GugulothRahul"
              target="_blank"
              rel="noopener noreferrer"
